...
def apply(sections,state,variation_index=0):
    for s in sections:
        ...
        elif 'hook' in n: base='drum_hook_density_lift'; v.append({'variation_type':'downbeat_impact','bar':s.get('bar_start',0),'duration_bars':1,'intensity':0.87 if variation_index else 0.75,'params':{}}); logger.info('HOOK_GROOVE_ESCALATION')
